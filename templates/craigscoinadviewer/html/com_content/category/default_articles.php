...
<?php else : ?>
    ...
    <?php endif; ?>
        ...
        <table class="category table table-striped table-bordered table-hover">qeqwceqwce
                    ...
                    <?php endif; ?>
                        ...
                        <?php if(in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
                            ...
                            <td headers="categorylist_header_date" class="list-date small">
                                <?php
                                echo JHtml::_(
                                        'date', $article->displayDate, $this->escape($this->params->get('date_format', JText::_('DATE_FORMAT_LC3')))
                                );
                                ?>
                            </td>
                            <?php endif; ?>
